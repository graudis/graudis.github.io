...
2. **ARR 의 저주**
   ...
   **[ 악연의 시작 2 ]**
   ...
   ( 2개월동안의 데이터 수집과 의견 교환 비용대비 터무니 없는 배상금 이였지만, **벤더사에서 공식 사과와 배상을 받았다는 것에 의미** 를 두기로 하였다. )
   
   필자가 Azure 벤더사와의 파이팅을 하는 것을 지켜 보던 자사의 Win 출신들의 엔지니어들에겐 **"벤더사의 말은 곧 법 이라는 금기"** 를 정면으로 반발을 하는 행동으로 보였을 것이다.
